...
.code
    imprimir_mensagem macro                         ; MACRO PARA IMPRIMIR MENSAGEM
        MOV AH, 09
        INT 21H
    endm
    main proc
...
cabecario proc
    ...
    LEA DX, msg4                    ; EXIBIR A MENSAGEM DAS OPERACOES DISPONIVEIS
    imprimir_mensagem
      
    LEA DX, msg1                    ; EXIBIR A MENSAGEM DAS OPERACOES DISPONIVEIS
    imprimir_mensagem
                  
    LEA DX, msg2                    ; EXIBIR A MENSAGEM PARA DIGITAR A OPERACAO
    imprimir_mensagem
